 ...
 */
module.exports = ({width: ww, height: hh, className = "loader-container", contentStyle = {}, text = "loading"}) => (
    <div className={className} >
        <ContainerDimensions>
            {({width = 200, height= 200}) => {
                ...
                return <Loader size={size} style={{ padding: size / 10, margin: "auto", display: "flex", ...contentStyle }} text={text} />;
            }}
        </ContainerDimensions>
    </div>);
