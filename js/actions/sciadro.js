...
export const CHANGE_PLAYING = "SCIADRO:CHANGE_PLAYING";
export const DELETE_FEATURE_ASSET = "SCIADRO:DELETE_FEATURE_ASSET";
export const DELETE_RESOURCE = "SCIADRO:DELETE_RESOURCE";
export const DELETING_RESOURCE = "SCIADRO:DELETING_RESOURCE";
...
export const FILTER_ASSETS = "SCIADRO:FILTER_ASSETS";
export const FILTER_MISSIONS = "SCIADRO:FILTER_MISSIONS";
export const HIDE_ADDITIONAL_LAYER = "SCIADRO:HIDE_ADDITIONAL_LAYER";
export const HIGHLIGHT_ANOMALY = "SCIADRO:HIGHLIGHT_ANOMALY";
export const LOADED_ASSETS = "SCIADRO:LOADED_ASSETS";
export const LOADED_MISSIONS = "SCIADRO:LOADED_MISSIONS";
export const LOADING_ANOMALIES = "SCIADRO:LOADING_ANOMALIES";
...
export const RESOURCE_DELETED = "SCIADRO:RESOURCE_DELETED";
export const SAVE_ERROR = "SCIADRO:SAVE_ERROR";
export const SAVING_MISSION = "SCIADRO:SAVING_MISSION";
...
export const deleteResource = (id) => ({ type: DELETE_RESOURCE, id});
export const deletingResource = (deleting) => ({ type: DELETING_RESOURCE, deleting});
...
export const filterAssets = (filterText) => ({ type: FILTER_ASSETS, filterText });
export const filterMissions = (filterText) => ({ type: FILTER_MISSIONS, filterText });
export const hideAdditionalLayer = (id) => ({ type: HIDE_ADDITIONAL_LAYER, id });
export const highlightAnomaly = (anomalyId) => ({ type: HIGHLIGHT_ANOMALY, anomalyId });
...
export const loadingAnomalies = (loading) => ({ type: LOADING_ANOMALIES, loading });
...
export const loadingMissionsData = (loading) => ({ type: LOADING_MISSION_DATA, loading });
...
export const resourceDeleted = (id) => ({ type: RESOURCE_DELETED, id });
export const saveError = (id, message) => ({ type: SAVE_ERROR, id, message: message || "sciadro.rest.saveError" });
export const savingMission = (saving) => ({ type: SAVING_MISSION, saving});
...
export const startPlayer = () => ({ type: CHANGE_PLAYING, playing: true });
...
export const loadMissionError = (errorOptions) => error({message: "sciadro.rest.loadMissionDataError", position: "tc", title: "Error", ...errorOptions});
export const saveAssetSuccess = (name) => success({message: "sciadro.assets.rest.saveSuccess", values: {name}, position: "tc", title: "Success"});
export const resourceDeletedSuccess = (name) => success({message: "sciadro.rest.deleteSuccess", values: {name}, position: "tc", title: "Success"});
export const resourceDeletedError = (name) => error({message: "sciadro.rest.deleteError", values: {name}, position: "tc", title: "Error"});
